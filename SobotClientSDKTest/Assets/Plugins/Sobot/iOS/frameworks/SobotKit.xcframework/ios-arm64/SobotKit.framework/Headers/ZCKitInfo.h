 ...
 *  阶段一新增:横屏是否隐藏系统状态栏
 *  默认 YES(沿用旧"横屏全隐"行为)
 *  仅作用于继承 SobotClientBaseController 的 VC,
 *  内部映射到 SobotBaseController.landscapeHideStatusBar(配合 enableAdaptiveLayout 生效)
 */
...
// @[{@"fieldName":@"key",@"fieldValue":@"SF123"}]
@property (nonatomic,strong) NSArray *extendFields;
// 获取状态字符串内容
