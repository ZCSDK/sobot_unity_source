...
// 未使用
@property (nonatomic,copy) NSString *extModelDarkPhoto;
...
@property (nonatomic,strong) NSString * menuPicDarkUrl;

// 0:预制，需要自己处理暗黑，1，使用menuPicDarkUrl图标
@property (nonatomic,assign) int  iconButton;
