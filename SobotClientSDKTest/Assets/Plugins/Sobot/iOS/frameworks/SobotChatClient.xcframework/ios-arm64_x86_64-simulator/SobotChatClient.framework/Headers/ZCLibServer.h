...
/// @param isLeave isLeave description
/// @param libConfig libConfig description
/// @param startBlock startBlock description
/// @param successBlock successBlock description
...
+(void)fileUploadForLeave:(NSString *) filePath
                ...
                config:(ZCLibConfig *) libConfig
                    start:(void(^)(void))startBlock
                  success:(void(^)(NSString *fileName,NSString *fileURL,ZCNetWorkCode code)) successBlock
                     fail:(void(^)(ZCNetWorkCode errorCode,NSString *errorMsg)) failBlock;
...
/// 解析机器人消息
/// @param sendModel sendModel description
/// @param dict dict description
/// @param _config _config description
/// @param isRobotUploadFileUrl isRobotUploadFileUrl description
/// @param startBlock startBlock description
/// @param successBlock successBlock description
/// @param progressBlock progressBlock description
/// @param failBlock failBlock description
+(SobotChatMessage *)parseRobotResult:(SobotChatMessage *) sendModel
               robotAnswer:(NSDictionary *)dict
                    config:(ZCLibConfig *) _config
      isRobotUploadFileUrl:(BOOL)isRobotUploadFileUrl
                     start:(void (^)(SobotChatMessage *message))startBlock
                   success:(void (^)(SobotChatMessage *message, ZCNetWorkCode code))successBlock
                  progress:(void (^)(SobotChatMessage *message))progressBlock
                                 fail:(void (^)(SobotChatMessage *message,NSString *errorMsg, ZCNetWorkCode code))failBlock;
...
/// 机器人问答，超时触发轮询
/// - Parameters:
///   - sendModel: sendModel description
...
+(void)getAiAgentAnswer:(SobotChatMessage *) sendModel
                   config:(ZCLibConfig *)config
                  timer:(NSTimer *) timer
                   start:(void (^)(SobotChatMessage *message))startBlock
                 success:(void (^)(SobotChatMessage *message, ZCNetWorkCode code))successBlock
