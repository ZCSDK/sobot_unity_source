...
@interface ZCOrderCusFiledsModel : NSObject
...
@property (nonatomic,strong) NSString *finalExplain;
@property (nonatomic,strong) NSString *explain;
// 附件限制大小
@property (nonatomic,assign) int maxStorage;
// 文件大小的提示
@property (nonatomic,strong) NSString *maxStorageTip;
...
- (void)updateFileListWithArray:(NSArray *)fileList;
- (NSString *)fileListJSONString;
@end
