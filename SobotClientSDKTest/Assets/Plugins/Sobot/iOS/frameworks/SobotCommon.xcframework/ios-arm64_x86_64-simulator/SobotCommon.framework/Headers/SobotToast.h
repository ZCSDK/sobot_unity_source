...
/// SDK新增 加载动效
/// @param circleTintColor 加载圆环的背景色
/// @param circleColor 加载圆环主题色 动效
/// @param byView 添加的位置
/// @param status 状态
-(void)showProgress:(UIColor*)circleTintColor circleColor:(UIColor *)circleColor byView:(UIView*)byView status:(NSString*)status;
