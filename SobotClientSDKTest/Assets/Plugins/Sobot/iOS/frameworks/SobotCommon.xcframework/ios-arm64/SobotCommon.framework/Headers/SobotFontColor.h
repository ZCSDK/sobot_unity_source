...
static SobotTypeColor const SobotColorBgSub2Dark1 = @"SobotColorBgSub2Dark1";//浅灰色背景、留言、帮助中心,暗黑对应纯黑
static SobotTypeColor const SobotColorBgSub2Dark2 = @"SobotColorBgSub2Dark2";//浅灰色背景、留言、帮助中心,暗黑对应纯黑
static SobotTypeColor const SobotColorBgSub2Dark3 = @"SobotColorBgSub2Dark3";//浅灰色背景、留言、帮助中心,暗黑对应纯黑
static SobotTypeColor const SobotColorBgMainDark1 = @"SobotColorBgMainDark1";//白色背景,转浅黑背景
static SobotTypeColor const SobotColorBgMainDark2 = @"SobotColorBgMainDark2";//白色背景,转浅黑背景
static SobotTypeColor const SobotColorBgMainDark3 = @"SobotColorBgMainDark3";//白色背景,转浅黑背景
static SobotTypeColor const SobotColorButtonBgMainDark1 = @"SobotColorButtonBgMainDark1";//浅色,消息按钮的背景的
...
static SobotTypeColor const SobotColorTextBlack = @"SobotColorTextBlack";//黑色文本颜色

// 线条颜色
static SobotTypeColor const SobotColorBorderLine  = @"SobotColorBorderLine";// #EBEBEB
...
static SobotTypeColor const SobotColorBorderD9 = @"SobotColorBorderD9";// 表单输入框边框颜色；
static SobotTypeColor const SobotColorBorder59 = @"SobotColorBorder59";// 表单输入框边框颜色；
// 阴影卡片的的线条颜色
static SobotTypeColor const SobotCommonColorBorderF0 = @"SobotCommonColorBorderF0";//
...
static SobotTypeColor const SobotColorBorderlineF0240 = @"SobotColorBorderlineF0240"; // 按钮边框线颜色
