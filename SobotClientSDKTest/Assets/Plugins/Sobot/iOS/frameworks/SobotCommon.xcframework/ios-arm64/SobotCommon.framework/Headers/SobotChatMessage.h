...
//    SobotMessageTypeRichJsonLoop = 9, // 对象,4.0.5去掉此定义，msgType=5，SobotMessageRichJsonTypeLoop即可确认
    ...
    SobotMessageRichJsonTypeVariable = 9,// 大模型变量收集的数据卡片  接口是5-25
...
//    对象类型：
    ...
    SobotMessageRichJsonTypeFORM_SUBMIT = 26,// 大模型变量表单提交
    SobotMessageRichJsonTypeAiCustomCard = 28,// 通用卡片
    SobotMessageRichJsonTypeTable = 501,// 大模型回复包含table
};
...
// 切换语言
   ...
   SobotMessageActionTypeSelLanguage = 53,
    ...
    /** 大模型机器人变量收集 */
    SobotMessageActionTypeVariable = 56,
    ...
    /**
     会话结束,未分配结束的设置
     */
    SobotMessageActionTypeChatOverWord                         = 20411,
...
@class ZCAnalysisInfo;
@class ZCAIButtonInfos;
/**
 通用卡片按钮信息
 */
...
// 0 图文，1 仅图
@property (nonatomic,assign) int businessSetType;
...
//记录大模型的回复消息是提交表单失败的消息 标记，默认NO
@property(nonatomic,assign) BOOL from_submit_error;
@property(nonatomic,strong) NSString *robotid;
// 历史记录是否来源于三方渠道
@property(nonatomic,assign) BOOL isFromThirdParty;

// 裁成二维数组 MSG + URL + TRANSFER，三方渠道的数据 需要单独处理，都放到按钮的下方 （排序规则 转人工、链接、消息 每个类型单独一行）
@property(nonatomic,strong)NSMutableArray *listButtomInfos;
@property(nonatomic,strong)NSMutableArray *listShowButtonInfos;
// 大模型机器人返回 按钮数据
...
// [新增] 知识来源信息
@property(nonatomic,strong)ZCAnalysisInfo *analysisInfo;
...
/**
 * 首条历史未读锚点：1=当前消息是本次结果中的首条未读，0/无值=不是锚点
 * 由历史会话接口 getChatDetailByCid 返回
 */
@property (nonatomic , assign) int firstUnreadAnchor;
...
// 替换@@[xxx,xxx]$$ 为超链接
-(NSString *)replaceSourcesOfKnowledge:(NSString *)text;
-(void)replaceAllSourcesOfKnowledge;
...
// 机器人点踩数据 扩展model
@interface ZCChatRealuateConfigInfo : SobotBaseEntity
...
@interface  ZCRealuateTagInfo: SobotBaseEntity
...
/**
 大模型问答知识来源展示
 "analysisInfo": {
     "showKbSource": true,  // Boolean. 标识是否展示来源。true: 展示; false: 不展示
     "fileContents": [      // Array. 来源列表
         {
             "sectionTypeEnum": "WEB",      // String. 来源类型: "WEB" (网页) / "FILE" (文件)
             "referenceUrl": "https://...", // String. 跳转链接 (文件下载地址或网页URL)
             "referenceTitle": "显卡介绍",    // String. 标题 (文件名或网页标题)
             "referenceDesc": "核心功能描述..." // String. 来源内容的摘要/描述
         }
        
     ]
 }
 */
@interface  ZCAnalysisInfo: SobotBaseEntity
// Boolean. 标识是否展示来源。true: 展示; false: 不展示
@property(nonatomic,assign) BOOL showKbSource;

// Array. 来源列表
@property(nonatomic,strong)NSMutableArray *fileContents;
// Array. 来源列表
@property(nonatomic,strong)NSMutableArray *usefileContents;
...
#pragma mark -- 大模型机器人按钮消息
@interface ZCAIButtonInfos : SobotBaseEntity
@property(nonatomic,strong) NSString *buttonId;
@property(nonatomic,strong) NSString *buttonAction;
@property(nonatomic,strong) NSString *label;
@property(nonatomic,strong) NSString *url;
@property(nonatomic,strong) NSString *transferGroupName;
@property(nonatomic,strong) NSString *transferGroupId;
@property(nonatomic,assign) int buttonType;
//"buttonInfos": [
//           {
//           "buttonId": "f3b23282e0d24853bef17e2b1d2cc327",
//           "buttonAction": "TRANSFER", //按钮动作类型: MSG-消息,URL-链接,TRANSFER-转人工
//           "label": "售后支持组", //按钮展示的文本内容
//           "url": "",
//           "transferGroupName": "售后支持组"
//           "transferId": "": "123"
//           },
//           {
//           "buttonId": "j9523282e0d24853bef17e2b1d2cc327",
//           "buttonAction": "URL",
//           "label": "链接",
...
/**
 ...
 "sectionTypeEnum": "WEB",      // String. 来源类型: "WEB" (网页) / "FILE" (文件)
             ...
             "referenceDesc": "核心功能描述..." // String. 来源内容的摘要/描述
 */
@interface  ZCFileContentInfo: SobotBaseEntity

@property(nonatomic,copy) NSString *fileId;
@property(nonatomic,copy) NSString *sectionId;
@property(nonatomic,copy) NSString *sectionTypeEnum;
@property(nonatomic,copy) NSString *referenceUrl;
@property(nonatomic,copy) NSString *referenceTitle;
@property(nonatomic,copy) NSString *referenceDesc;

// YES时添加
@property(nonatomic,assign) BOOL usedFlag;
